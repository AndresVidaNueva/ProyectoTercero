...
<html>
  <head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{asset('img/portada.jpg')}}">
            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-6">
                <div class="info d-flex justify-content-center flex-column p-4 h-100">
                  <div class="py-5">
                    <h1 class="display-6 fw-bold">CURXXOS100</h1>
                    <p class="fw-light mb-0">Cursos que desafían, mentes que prosperan.</p>
                  </div>
                </div>
              </div>
